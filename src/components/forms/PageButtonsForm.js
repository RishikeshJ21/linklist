...
import { faGripLines, faTrash, faPlus, faSave } from '@fortawesome/free-solid-svg-icons';
...
export default function PageButtonsForm({ user, page }) {
  ...
  const allButtons = [
    { key: 'button1', label: 'Button 1', icon: faPlus, placeholder: 'Enter text' },
    { key: 'button2', label: 'Button 2', icon: faTrash, placeholder: 'Enter text' },
